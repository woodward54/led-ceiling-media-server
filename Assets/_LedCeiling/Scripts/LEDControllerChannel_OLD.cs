...
//             Thread.Sleep((int)(new System.Random().NextDouble() * retryDelay));
...
//                         {
//                             Debug.Log($"SocketException writing to socket for {HostName}: {ex.Message}, Error Code: {ex.SocketErrorCode}");
//                             _myUi.Status = ConnectedStatus.Disconnected;
//                             ControllerSocket oldSocket;
//                             _HostControllerSockets.TryRemove(HostName, out oldSocket);
//                         }
...
//     {
//         private NetworkInstabilitySimulator _networkSimulator = new NetworkInstabilitySimulator();
...
//             if (_networkSimulator.ShouldDropPacket())
//             {
//                 throw new SocketException((int)SocketError.NetworkDown);
//             }

//             _networkSimulator.SimulateLatency();
...
//                 try
//                 {
//                     result = (uint)_socket.Send(data);
//                     break; // Exit loop if successful
//                 }
//                 catch (SocketException ex)
//                 {
//                     retryCount--;
//                     Debug.LogWarning($"SocketException on send to {HostName}: {ex.Message}, Error Code: {ex.SocketErrorCode}, Retries left: {retryCount}");
